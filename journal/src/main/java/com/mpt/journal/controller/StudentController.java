...
public class StudentController {
    ...
    public String addStudent(@RequestParam String name,
                             ...
                             @RequestParam String yearofenrollment) {
        StudentModel newStudent = new StudentModel(0, name, lastName, firstName, course, faculty, yearofenrollment); // тут мы получаем данные с главных полей, id задается автоматически из нашего репозитория
    ...
    public String updateStudent(@RequestParam int id,
                                ...
                                @RequestParam String faculty,
                                @RequestParam String yearofenrollment) {
        StudentModel updatedStudent = new StudentModel(id, name, lastName, firstName, course, faculty, yearofenrollment); // Получаем новые данные из полей для обновления
